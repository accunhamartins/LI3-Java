...
public class Input implements Serializable {
    ...
    /**
     * Método que transforma o input de um utilizador numa String.
     *
     * @return String dada pelo utilizador
     */
 public static String lerString() {
    ...
    /**
     * Método que tranforma o input de um utilizador num int.
     *
     * @return int dado pelo utilizador
     */
    ...
    /**
     * Método que tranforma o input de um utilizador num double.
     *
     * @return double dado pelo utilizador
     */
  public static double lerDouble() {
    ...
    /**
     * Método que tranforma o input de um utilizador num float.
     *
     * @return float dado pelo utilizador
     */
   public static float lerFloat() {
    ...
    /**
     * Método que tranforma o input de um utilizador num boolean.
     *
     * @return boolean dado pelo utilizador
     */
   public static boolean lerBoolean() {
    ...
    /**
     * Método que tranforma o input de um utilizador num short.
     *
     * @return short dado pelo utilizador
     */
